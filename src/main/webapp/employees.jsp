                        ...
                        <tr>
                            <td>
                                <div class="employee-name">
                                    ...
                                    <span>Sherbadhur deuba</span>
                                </div>
                            </td>
                            <td>Human Resources</td>
                            <td>Admin</td>
                            <td>Harka Sampang@example.com</td>
                        ...
                        <tr>
                            <td>
                                <div class="employee-name">
                                    ...
                                    <span>GaganThapa</span>
                                </div>
                            </td>
                            <td>Mechanical</td>
                            <td>Employee</td>
                            <td>gagan.thapa@example.com</td>
                        ...
                        <tr>
                            <td>
                                <div class="employee-name">
                                    ...
                                    <span>Gopi Hamal</span>
                                </div>
                            </td>
                            <td>Civil</td>
                            <td>Manager</td>
                            <td>gopi.hamal@example.com</td>
