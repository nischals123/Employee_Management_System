        ...
        <div class="content-card">
            <section class="profile-section">
                ...
                <div class="form-grid">
                    ...
                    <%
					    Department dept = new DepartmentDAO().getDepartmentById(user.getDepartmentId());
					%>
					<input type="text" value="<%= (dept != null) ? dept.getName() : "" %>" disabled />
					</div>
                    <div class="form-group">
                        <label>Role</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="Rs. ${employee.salary != null ? employee.salary : '10000'}" disabled />
                    </div>
                    <div class="form-group">
