        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="register.jsp" class="btn btn-primary">Get Started <i class="fas fa-arrow-right"></i></a>
            ...
            <div class="hero-image">
                <img src="images/hero-illustration.svg" alt="EMS Dashboard" onerror="this.src='https://cdn.pixabay.com/photo/2017/07/31/11/44/laptop-2557576_1280.jpg'; this.onerror=''">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="benefits-container">
                <div class="benefit-image">
                    <img src="images/benefits-illustration.svg" alt="EMS Benefits" onerror="this.src='https://cdn.pixabay.com/photo/2017/07/31/11/44/laptop-2557576_1280.jpg'; this.onerror=''">
                </div>
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <div class="about-cta">
                        <a href="register.jsp" class="btn btn-primary">Join Us Today</a>
                    </div>
                </div>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-content">
                ...
                <p>Join thousands of companies already using EMS to streamline their HR operations.</p>
